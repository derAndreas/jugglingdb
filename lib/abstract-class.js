...
// DEBUG: Get pluralize and camelize from railwayjs
var pluralize  = require('../vendor/inflection.js').pluralize;
...
AbstractClass.hasAndBelongsToMany = function(anotherClass, params) {
    var methodName = params.as,
        ...
        fkLeft = params.foreignKey || (accessorLeft + '_id'),
        fkRight = accessorRight + '_id';
